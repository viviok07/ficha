const races = [
  { id: 'humano', name: 'Humano', icon: '🧑', description: 'Igual a nós: determinado, aprende rápido e se adapta a qualquer profissão ou lugar do mundo.', traits: ['Copia o truque que viu', 'Puxa papo com qualquer um', 'Levanta e tenta de novo', 'Lê o mapa e acha o caminho'] },
  { id: 'anao', name: 'Anão', icon: '⛏️', description: 'Baixinho e forte como rocha, vive em montanhas e cria armas e armaduras excelentes.', traits: ['Martela ferro na forja', 'Sente ouro na pedra', 'Aguenta pancada sem cair', 'Enxerga no escuro da mina'] },
  { id: 'elfo', name: 'Elfo', icon: '🌿', description: 'Alto, elegante e de orelhas pontudas, vive nas florestas e se move sem fazer barulho.', traits: ['Anda sem quebrar folha seca', 'Enxerga no escuro do mato', 'Ouve passos bem de longe', 'Canta canções de mil anos'] },
  { id: 'halfling', name: 'Halfling', icon: '🍀', description: 'Pequenino, ágil e corajoso; adora comida, bons amigos e tem muita sorte.', traits: ['Escapa por qualquer fresta', 'Some atrás de um barril', 'Acha moeda de ouro no chão', 'Encara gigante sem fugir'] },
  { id: 'draconato', name: 'Draconato', icon: '🐲', description: 'Um herói-dragão com escamas coloridas, cauda e uma baforada elemental impressionante.', traits: ['Empurra portão de pedra', 'Solta baforada de fogo', 'Escamas duras como escudo', 'Se equilibra com a cauda'] },
  { id: 'tabaxi', name: 'Tabaxi', icon: '🐱', description: 'O povo-gato: curioso, veloz, com garras e talento para escalar lugares difíceis.', traits: ['Escala parede com as garras', 'Corre mais que o cavalo', 'Cai sempre de pé', 'Desvia da flecha num pulo'] },
  { id: 'gnomo', name: 'Gnomo', icon: '🧠', description: 'Pequeno inventor de cabelos coloridos, mente brilhante, ilusões e piadas espertas.', traits: ['Inventa geringonça na hora', 'Faz surgir flor de ilusão', 'Desmonta tudo para espiar', 'Conversa com bichinhos'] },
];

const classes = [
  { id: 'guerreiro', name: 'Guerreiro', icon: '🛡️', description: 'O mestre das armas, vai para a linha de frente com espada, escudo e armadura pesada.', attributes: { forca: 5, destreza: 3, inteligencia: 2, sabedoria: 3 }, traits: ['Luta com espada e machado', 'Segura o escudo firme', 'Levanta depois do golpe', 'Grita ordem na batalha'] },
  { id: 'barbaro', name: 'Bárbaro', icon: '💢', description: 'O guerreiro furioso que confia na força bruta, fica mais forte e quase não sente dor.', attributes: { forca: 5, destreza: 3, inteligencia: 1, sabedoria: 4 }, traits: ['Ataca gritando de raiva', 'Segue lutando machucado', 'Grito que espanta lobo', 'Fareja inimigo escondido'] },
  { id: 'ladino', name: 'Ladino', icon: '🗝️', description: 'Rápido, silencioso e esperto; abre fechaduras, desarma armadilhas e ataca de surpresa.', attributes: { forca: 2, destreza: 5, inteligencia: 4, sabedoria: 3 }, traits: ['Abre cadeado com grampo', 'Some na sombra do beco', 'Ataca pelas costas', 'Vê a armadilha no chão'] },
  { id: 'patrulheiro', name: 'Patrulheiro', icon: '🏹', description: 'O protetor da natureza, arqueiro incrível que rastreia pegadas e sobrevive na floresta.', attributes: { forca: 3, destreza: 5, inteligencia: 3, sabedoria: 5 }, traits: ['Acerta a flecha bem longe', 'Segue pegadas no barro', 'Chama o lobo com assobio', 'Acende fogueira na chuva'] },
  { id: 'clerigo', name: 'Clérigo', icon: '✨', description: 'O guerreiro da cura, usa fé e magia de luz para ajudar amigos e afastar monstros sombrios.', attributes: { forca: 3, destreza: 2, inteligencia: 3, sabedoria: 5 }, traits: ['Fecha ferida com a mão', 'Faz luz espantar monstro', 'Reza antes da batalha', 'Segura a mão de quem chora'] },
  { id: 'mago', name: 'Mago', icon: '🪄', description: 'O cientista da magia, estuda livros antigos e lança feitiços como fogo ou invisibilidade.', attributes: { forca: 1, destreza: 3, inteligencia: 5, sabedoria: 4 }, traits: ['Decora feitiço do livro', 'Lê runas em pedra velha', 'Vê brilho de magia no ar', 'Faz poção no caldeirão'] },
  { id: 'bardo', name: 'Bardo', icon: '🎵', description: 'O artista do grupo, usa música, poemas e piadas para fortalecer amigos e confundir vilões.', attributes: { forca: 2, destreza: 4, inteligencia: 4, sabedoria: 3 }, traits: ['Toca alaúde na batalha', 'Convence o guarda a abrir', 'Conta história de dragão', 'Faz a praça inteira dançar'] },
];
